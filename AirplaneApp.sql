...
--
-- Host: localhost    Database: airplane_app
-- ------------------------------------------------------
...
INSERT INTO `bank_account` VALUES (1,'Tom',23),(2,'Jerry',3700),(3,'Donald',2277);
...
CREATE TABLE `order` (
  ...
  `reserve_code` varchar(6) DEFAULT NULL,
...
-- Dump completed on 2020-03-04 17:33:38
